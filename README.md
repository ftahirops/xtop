<p align="center">
  <img src="https://img.shields.io/badge/xtop-v0.34.6-00d4aa?style=for-the-badge&logo=linux&logoColor=white" alt="version"/>
...
### Statistical RCA Intelligence (v0.34.6)
...
```bash
# Ubuntu/Debian (amd64)
wget https://github.com/ftahirops/xtop/releases/download/v0.34.6/xtop_0.34.6-1_amd64.deb
sudo dpkg -i xtop_0.34.6-1_amd64.deb

# RHEL/Rocky/Fedora (x86_64)
wget https://github.com/ftahirops/xtop/releases/download/v0.34.6/xtop-0.34.6-1.x86_64.rpm
sudo rpm -i xtop-0.34.6-1.x86_64.rpm
```
...
cd xtop
CGO_ENABLED=0 go build -ldflags="-s -w -X github.com/ftahirops/xtop/cmd.Version=0.34.6" -o xtop .
